...
Description = 'Contains a function (Compare-PSVersionCommand) to compare commands and parameters between two PowerShell versions.'
...
FunctionsToExport = 'Compare-PSVersionCommand'
